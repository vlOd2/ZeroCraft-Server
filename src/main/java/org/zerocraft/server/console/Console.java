package org.zerocraft.server.console;
...
public class Console {
	...
	private void init() {
		...
		this.frame = new JFrame("ZeroCraftServer - Console");
		...
		helpAbout.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, 
						String.format("%s", ZeroCraftServer.VERSION_STR),
						"ZeroCraftServer - About", JOptionPane.INFORMATION_MESSAGE | JOptionPane.OK_OPTION);
			}
		});
	...
	public void write(String str, Color color, boolean newLine) {
		Runnable runnable = new Runnable() {
			@Override
			public void run() {
				if (Console.this.txtContents == null) {
					return;
				}
				...
				Console.this.txtContents.setCaretPosition(Console.this.txtContents.getDocument().getLength());
				Console.this.txtContents.setCharacterAttributes(attributeSet, false);
				Console.this.txtContents.replaceSelection(str + (newLine ? "\n" : ""));
				Console.this.txtContents.setCharacterAttributes(
